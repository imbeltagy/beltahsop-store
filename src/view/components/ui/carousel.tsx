    ...
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ...
          : "start-1/2 -top-4 -translate-x-1/2 rotate-90",
        className,
      )}
    ...
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ...
          : "start-1/2 -bottom-4 -translate-x-1/2 rotate-90",
        className,
      )}
...
function CarouselPreview({ previewImages }: { previewImages: string[] }) {
  ...
  return (
    <div className="relative mt-3">
      <div
        className={cn(
          "no-scrollbar flex flex-wrap gap-2 overflow-x-auto px-2 py-1",
        )}
      >
          ...
          <button
            ...
            className={cn(
              ...
              current === index
                ...
                : "border-border cursor-pointer hover:shadow-sm",
            )}
          >
            <Image
              src={src}
